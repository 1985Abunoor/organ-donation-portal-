    ...
    <legend>Personal Information:</legend>
      ...
      <div class="row">
        <div class="col-4 form-group mt-3">
          <label for="origin_needed">Origin Needed</label>
          <select name="origin_needed" id="origin_needed" class="form-select">
    ...
    <legend>Emergency Contact:</legend>
      <div class="row">
        <div class="col-md-4 form-group">
          ...
          <input type="text" name="emergency_contact_name" class="form-control" id="name" placeholder="Your Name"  required>
      ...
      <div class="text-center"><button name="new_patient" type="submit">Send Request</button></div>
    </form>
